function ThreeLayerConvNet_Trainer(X_train, y_train, X_val, y_val)
    ...
    [loss_history, train_acc_history, val_acc_history] = Solver_train_params(X_train, y_train, X_val, y_val, num_epochs, batch_size, update_rule, learning_rate, lr_decay, verbose, params); 
